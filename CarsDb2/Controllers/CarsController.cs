...
namespace CarsDb2.Controllers
{
    public class CarsController : Controller
    {
        ...
        {
            var carsDbContext = _context.Cars.Include(c => c.Dealer).Include(c => c.Manufacturer);
            return View(await carsDbContext.ToListAsync());
        }
        ...
        {
            ViewData["CarDealerId"] = new SelectList(_context.CarDealers, "Id", "Id");
